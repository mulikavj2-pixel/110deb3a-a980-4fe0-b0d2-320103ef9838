...
export const metadata: Metadata = {
  ...
  description: "Discover exceptional specialty coffee crafted daily. Join our community for the perfect cup in a warm, welcoming atmosphere downtown.",
  keywords: "coffee shop, specialty coffee, espresso, latte, café, downtown coffee",
  ...
  openGraph: {
    title: "Brew Haven - Premium Specialty Coffee Shop",
    description: "Discover exceptional specialty coffee crafted daily. Join our community for the perfect cup in a warm, welcoming atmosphere.",
    type: "website",
    siteName: "Brew Haven",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765811497626-ygiav8k9.jpg",
        alt: "Fresh brewed coffee at Brew Haven"
      }
    ]
  },
  twitter: {
    ...
    title: "Brew Haven - Premium Specialty Coffee Shop",
    description: "Exceptional coffee crafted with passion. Visit us downtown.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765811497626-ygiav8k9.jpg"]
  },
  robots: {
    index: true,
    follow: true
